...
const DefaultAppearanceButtons = () => {
  ...
  const renderButtons = () => {
    return daButtonsArr.map((buttonData, index) => {
      return (
  ...
  return (
    <div className="grid">
      <div className="col-12">
        <div className="card">
          <h5>Default Appearance Buttons</h5>
...
export default DefaultAppearanceButtons;
