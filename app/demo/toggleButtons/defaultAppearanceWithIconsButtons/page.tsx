...
import { dawiButtonsArr } from '@/mockedData/defaultAppearanceWithIconsBtnsData';
import { ButtonData } from '@/types/buttonsPage';
import { VCToggleButtonProps } from '@/types/vcToggleButton';
import { useState } from 'react';

const DefaultAppearanceWithIconsButtons = () => {
  // LOCAL STATES
  ...
  const renderButtons = () => {
    return dawiButtonsArr.map((buttonData, index) => {
      return (
  ...
  return (
    <div className="grid">
      <div className="col-12">
        <div className="card">
          <h5>Default Appearance(With Icons)</h5>
...
export default DefaultAppearanceWithIconsButtons;
